...
int main() {
	...
	//BloomFilter<long long, int>int_string_filter(bitcount, 2, as, bs);
	//BloomFilter<char, char>int_string_filter(bitcount, 2, as, bs);
	//BloomFilter<short, string>int_string_filter(bitcount, 2, as, bs);
